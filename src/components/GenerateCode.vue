    ...
    <div class="form-code-modal fixed inset-0 bg-slate-900/75 flex items-start justify-center z-20 overflow-y-auto" @click.self="hideCodeModal">
        <div class="bg-white p-12 rounded shadow-lg relative w-5xl my-8">
            ...
            <div class="relative">
                ...
                <textarea class="border w-full h-64 rounded-lg p-2 font-mono text-sm" readonly>{{ formCode }}</textarea>
            </div>
            ...
            <div class="flex items-start gap-4 mt-4">
                ...
                <input class="border w-full rounded-lg p-2 font-mono text-sm" :value="props.form.email" readonly />
                <CopyButton :copyText="props.form.email" />
            </div>

            <div class="flex items-start gap-4 mt-4">
                <p class="font-bold w-32">From</p>
                <input class="border w-full rounded-lg p-2 font-mono text-sm" :value="`[_site_title] <wordpress@${props.form.domain}>`" readonly />
            ...
            <div class="flex items-start gap-4 mt-4">
                ...
                <div class="relative w-full">
                    ...
                    <textarea class="border w-full h-32 rounded-lg p-2 font-mono text-sm" readonly>{{ additionalHeaders }}</textarea>
                </div>
            </div>
            ...
            <div class="flex items-start gap-4 mt-4">
                ...
                <div class="relative w-full">
                    ...
                    <textarea class="border w-full h-64 rounded-lg p-2 font-mono text-sm" readonly>{{ messageBody }}</textarea>
                </div>
            </div>
            ...
            <div class="flex items-start gap-4 mt-4">
                ...
                <div class="relative w-full">
                    ...
                    <textarea class="border w-full h-32 rounded-lg p-2 font-mono text-sm" readonly>{{ fileAttachments }}</textarea>
                </div>
            </div>
            ...
            <div class="relative">
                ...
                <textarea class="border w-full h-64 rounded-lg p-2 font-mono text-sm" readonly>{{ css }}</textarea>
            </div>
...
function generateMessageBody(form: Form): string {
    if (form) {
        ...
        const introText = form.introText ? form.introText : `The '${form.name}' form was submitted on your website${domain}.<br/>The response is below:`;
