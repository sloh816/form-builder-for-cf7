        ...
        <template #preview>
            ...
            <div class="indiga-toggle-switch" :data-field-id="props.id">
                ...
                <div class="indiga-toggle-switch-button-wrapper" :data-checked="props.default ? 'true' : 'false'" style="display: none">
                    <button class="indiga-toggle-switch-button" :aria-label="`Toggle currently: ${props.default ? props.onLabel : props.offLabel}. Click to toggle ${!props.default ? props.onLabel : props.offLabel}`" type="button">
