	...
	<div class="form-preview mb-16">
		...
		<div class="form-preview__fields grid gap-4 relative">
			<div v-for="(field, index) in props.currentForm.fields" :key="index" class="relative">
				<button
					class="text-sm text-indigo-700 absolute flex items-center gap-2 -top-[16px] cursor-pointer opacity-0 hover:opacity-100 transition-all duration-200 left-0 z-10"
